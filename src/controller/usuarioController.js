    ...
    const usuarioPadrao = papel === "psicologo"
      ? {
          ...
          perfil: {
            ...
            bio: perfil.bio || "Psicólogo especializado em TCC",
            idade:perfil.idade || "",
...
exports.atualizarUsuario = async (token, perfilAtualizado) => {
  ...
  // Preservar a foto existente caso não seja enviada uma nova
  if (usuario.perfil && usuario.perfil.foto && !perfilAtualizado.perfil?.foto) {
